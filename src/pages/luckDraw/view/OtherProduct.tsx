		...
		<div>
			<div className="px-4">
				<div className=" bg-[url('/src/assets/img/common/smallBg.png')] h-[460px] w-full bg-cover pt-[80px] relative z-1">
					...
					<div className=" flex justify-center pr-4 mt-6 ">
						<img src={other2_1} className="w-[109px]" alt="" />
						<img src={other2_2} className="w-[109px]" alt="" />
						<img src={other2_3} className="w-[109px]" alt="" />
					</div>
			...
			<div className=" px-4">
				<div className=" bg-[url('/src/assets/taiImg/luck2/other5_bg.png')] h-[139px] w-full bg-cover mt-4 flex justify-between px-1 pt-10">
					<img src={other5_1} className="w-[163px] h-[87px]" alt="" />
					<img src={other5_2} className="w-[163px] h-[87px]" alt="" />
				</div>
			</div>

			<div className=" flex justify-between px-4 mt-2">
				<img src={other6_1} className=" w-[168px] h-[234px]" alt="" />
				<div className=" flex flex-col justify-between">
					<img src={other6_2} className=" w-[168px] h-[113px]" alt="" />
					<img src={other6_3} className=" w-[168px] h-[113px]" alt="" />
				</div>
			</div>
